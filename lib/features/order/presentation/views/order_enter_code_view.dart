...
class OrderEnterCodeView extends StatelessWidget {
  const OrderEnterCodeView({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text('Подверждение заказа', style: TextStyles.black_18_w700,),
                SizedBox(height: 15.h),
                Text('Мы отправили SMS-код на +7 (700) 323-32-34 \nвведите его для подтверждения заказа', style: TextStyles.grey_14_w400, textAlign: TextAlign.center),
